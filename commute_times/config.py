...
FIRST_OR_FOURTH_TO_OTHER_QUAD_FACTOR_SHAPE = 10.0
...
BUS_FACTOR_MODE = 1.5
BUS_FACTOR_SHAPE = 25.0

TRAIN_FACTOR_MODE = 0.5
TRAIN_FACTOR_SHAPE = 25.0

BIKE_FACTOR_MODE = 3.0 
BIKE_FACTOR_SHAPE = 25.0

WALK_FACTOR_MODE = 6.0
WALK_FACTOR_SHAPE = 25.0
